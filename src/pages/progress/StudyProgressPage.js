...
const StudyProgressPage = () => {
    ...
    return (
        <PageLayout activeTab="progress">
            <motion.div
                className="min-h-full w-full bg-gray-100"
                initial={{opacity: 0}}
                animate={{opacity: 1}}
                ...
                <main className="flex-1 overflow-y-auto px-4 pb-16">
                    ...
                    >
                        <div className="flex justify-between items-start mb-2">
                            ...
                            <span
                                className="bg-blue-400 text-white px-2 py-1 rounded-full text-xs">第{progressData.currentDay}天</span>
                        </div>
